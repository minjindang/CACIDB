...
public partial class Allowance_Ins_01 : IMDInsertUI
{
    ///// <summary>
    ...
    public override DataTO PopulateData()
    {
        ...
        //apPjTo.setValue("Com_Code", this.lbl_Com_Code.Text);
    ...
    public override void SetProp()
    {
        ...
        ProgNm = "獎補助作業─內網創業圓夢計畫資料新增畫面";//程式名稱
    ...
    public override void SetDefault()
    {
        ...
        DataTO to = (DataTO)Session[ICommonUI.Web_ID + Session.SessionID + "Allowance_Ins_01"];
    ...
    //{
    //    //return base.BeforeHandleInsert(ito, dt);
    //    string msg = string.Empty;
    //    if (!string.IsNullOrEmpty(txt_Com_Name.Text))//團體
    //    {
    //        if(string.IsNullOrEmpty(txt_Com_CttCell.Text))
    //            msg = "\\r\\n請輸入【手機】";
    //        else if(string.IsNullOrEmpty(txt_Com_Email.Text))
    //            msg += "\\r\\n請輸入【E-MAIL】";
    //        else if (string.IsNullOrEmpty(txt_Com_OPAddr.Text))
    //            msg += "\\r\\n請輸入【地址】";
    //    }
    //    else//個人
    //    {
    //        if (string.IsNullOrEmpty(txt_Com_BsCell.Text))
    //            msg = "\\r\\n請輸入【手機】";
    //    }
    //    if (!string.IsNullOrEmpty(msg))
    //    {
    //        ShowMsgBox(this.Page, msg);
    //        return false;
    //    }
    //    else
    //        return true;
