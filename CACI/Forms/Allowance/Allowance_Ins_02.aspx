<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterDetailPage.master"
    AutoEventWireup="true" CodeFile="Allowance_Ins_02.aspx.cs" Inherits="Allowance_Ins_02" %>
                ...
                <div style="width: 100%">
                    <table class="table_gray" cellpadding="0" cellspacing="0" border="1" width="97%"
                        ...
                        <tr>
                            ...
                            <td class="text_2c">
                                <asp:UpdatePanel ID="up_Com_Tonum" runat="server">
                                    <ContentTemplate>
                                        <kd:CoIDNumTextBox ID="txt_Com_Tonum" runat="server" title="立案字號" AutoPostBack="true"
                                            OnTextChanged="txt_Com_Tonum_TextChanged" isAllowNull="false"></kd:CoIDNumTextBox>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text_2c">
                                <asp:UpdatePanel ID="up_Com_Capital" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <kd:NumTextBox ID="txt_Com_Capital" runat="server" title="資本額" DB_DecLength="0" DB_IntLength="18"
                                            isAllowNull="true"></kd:NumTextBox>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                            <td class="title_2c">
                            ...
                            <td class="text_2c">
                                <asp:UpdatePanel ID="up_Com_LTover" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <kd:NumTextBox ID="txt_Com_LTover" runat="server" title="年營業額" DB_DecLength="0" DB_IntLength="10"
                                            isAllowNull="true"></kd:NumTextBox>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="text_2c">
                                <asp:UpdatePanel ID="up_Com_OrgForm" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                            ...
                            <td class="text_2c">
                                <asp:UpdatePanel ID="up_Com_Boss" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                ...
                <td>
                    <table class="table_lightblue" border="1" width="100%">
                        ...
                        <tr>
                            ...
                            <td class="lightblue_tb_text_more">
                                <kd:StrTextBox ID="txt_Aas_Amount" runat="server" DB_Length="50" title="補助金額" isAllowNull="true" ValGroup="grvQuery"></kd:StrTextBox>
