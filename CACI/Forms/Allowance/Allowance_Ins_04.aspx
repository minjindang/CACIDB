<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterDetailPage.master"
    AutoEventWireup="true" CodeFile="Allowance_Ins_04.aspx.cs" Inherits="Allowance_Ins_04" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MasterInsertContent" runat="Server">
    <table class="table_gray" cellpadding="0" cellspacing="0" border="1" width="100%">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <kd:IDNumTextBox ID="txt_Com_Tonum" runat="server" title="身分證字號" AutoPostBack="true"
                            isAllowNull="false" OnTextChanged="txt_Com_Tonum_TextChanged"></kd:IDNumTextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="text_2c">
                <kd:StrTextBox ID="txt_Com_CttTel" runat="server" DB_Length="20" title="計劃聯絡人電話"
        ...
        <tr>
            ...
            <td class="text_2c">
                <kd:StrTextBox ID="txt_Com_Fax" runat="server" DB_Length="20" title="計劃聯絡人傳真" isAllowNull="false"></kd:StrTextBox>
            </td>
            <td class="title_2c">
                <span class="style1">*</span>計劃聯絡人EMAIL:
            </td>
            <td class="text_2c">
                <kd:StrTextBox ID="txt_Com_CttMail" runat="server" DB_Length="20" title="計劃聯絡人EMAIL"
                    isAllowNull="false"></kd:StrTextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="title_2c">
                <span class="style1">*</span>補助金費:
            </td>
            <td class="text_2c">
                <kd:StrTextBox ID="txt_ApPj_AowAmt" runat="server" DB_Length="50" title="補助金費" isAllowNull="false"></kd:StrTextBox>
                        ...
                        <td>
                            <table class="table_lightblue" border="1" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td class="lightblue_tb_text_more">
                                        <kd:IDNumTextBox ID="txt_Com_Tonum2" runat="server" title="身份字號" ValGroup="grvQuery"></kd:IDNumTextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="lightblue_tb_title_more">
                                    ...
                                    <td class="lightblue_tb_text_more">
                                        <kd:StrTextBox ID="txt_Com_BsTel" runat="server" DB_Length="20" title="聯絡電話" Width="95%"
                                            ValGroup="grvQuery"></kd:StrTextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="lightblue_tb_text_more" colspan="3">
                                        <kd:StrTextBox ID="txt_Com_OPAddr2" runat="server" DB_Length="200" Width="95%" title="地址"
                                            ValGroup="grvQuery"></kd:StrTextBox>
                                    </td>
                                </tr>
                                <tr>
