<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterDetailPage.master"
    AutoEventWireup="true" CodeFile="PjJudge_Ins_01.aspx.cs" Inherits="PjJudge_Ins_01" %>
                            ...
                            <table cellpadding="0" width="100%" cellspacing="0">
                                <tr>
                                    <td>
                                        ...
                                        <div style="float: left; position: absolute; margin: 0px 10px 0px 650px; background-color: white;
                        ...
                        <td>
                            <asp:Panel ID="pnlGridView" runat="server" Width="737px" class="detail_result_more">
                                <asp:GridView ID="grvQuery" runat="server" AutoGenerateColumns="False" Width="100%"
                                    BorderWidth="1px" DataKeyNames="Comm_Code" CssClass="table_lightblue"  style=" margin-top:0px; "
