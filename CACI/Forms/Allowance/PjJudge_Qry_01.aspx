<%@ Page Title="" Language="C#" MasterPageFile="~/Master/QueryMasterPage.master"
    AutoEventWireup="true" CodeFile="PjJudge_Qry_01.aspx.cs" Inherits="PjJudge_Qry_01" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="QueryConditionContent" runat="Server">
    <table class="table_gray" cellpadding="0" cellspacing="0" border="1" width="100%">
        ...
        <tr>
            ...
            <td class="text_2c">獎補助專案 </td>
            <td class="title_2c">專案名稱: </td>
            <td class="text_2c">
                <kd:StrTextBox ID="txt_Pj_Name" runat="server" title="專案名稱" DB_Length="50"></kd:StrTextBox>
            </td>
        </tr>
    </table>
</asp:Content>
...
<asp:Content ID="Content6" ContentPlaceHolderID="QueryResultContent" runat="Server">
    <asp:Panel ID="pnlGridView" runat="server" ScrollBars="None" class="search_result">
        <asp:GridView ID="grvQuery" runat="server" AllowPaging="True" PagerSettings-Visible="false"
            ...
            DataKeyNames="Pj_Code" AllowSorting="True" EnableViewState="true">
            <PagerSettings Visible="False" />
            <Columns>
                <asp:ButtonField ButtonType="Image" CommandName="mod" ImageUrl="~/image/btn_Eneage.png">
                ...
                <asp:BoundField DataField="Pj_Judge_Count" HeaderStyle-Font-Bold="false" HeaderText="已設定委員數">
                    <HeaderStyle CssClass="table_data_lightblue_head" />
                </asp:BoundField>
            </Columns>
