<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterDetailPage.master"
    AutoEventWireup="true" CodeFile="Committee_Ins_01.aspx.cs" Inherits="Committee_Ins_01" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MasterInsertContent" runat="Server">
    <table class="table_gray" cellpadding="0" cellspacing="0" border="1" width="100%">
        ...
        <tr>
            ...
            <td class="text_2c">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <kd:IDNumTextBox ID="txt_Comm_IDNO" runat="server" title="身分證字號" isAllowNull="false"
                            AutoPostBack="true" OnTextChanged="txt_Comm_IDNO_TextChanged"></kd:IDNumTextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        </tr>
                            ...
                            <tr>
                                <td>
                                    <kd:NumTextBox ID="txt_Comm_Bank_Num" runat="server" DB_IntLength="3" DB_DecLength="0"
                                        title="銀行代碼" isAllowNull="false" Width="40px" AutoPostBack="true" OnTextChanged="txt_Comm_Bank_Num_TextChanged"></kd:NumTextBox>
                                </td>
                                <td>
                                    <asp:Label ID="lbl_Comm_Bank_Name" runat="server" Text=""></asp:Label>
                                </td>
                                <td>
                                    <kd:StrTextBox ID="txt_Comm_Bankno" runat="server" DB_Length="20" title="銀行帳號" isAllowNull="false"></kd:StrTextBox>
                                </td>
                            </tr>
                        </table>
                    </ContentTemplate>
        ...
        <tr>
            ...
            <td class="text_2c" colspan="3">
                <kd:StrTextBox ID="txt_Comm_BkName" runat="server" DB_Length="50" title="戶名" isAllowNull="false"></kd:StrTextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="text_2c" colspan="3">
                <asp:CheckBoxList ID="ckl_Comm_CoTerms" runat="server" RepeatDirection="Horizontal"
                    DataTextField="Sys_CdText" DataValueField="Sys_CdCode">
                </asp:CheckBoxList>
            </td>
        </tr>
    </table>
