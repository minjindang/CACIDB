<%@ Page Title="" Language="C#" MasterPageFile="~/Master/QueryMasterPage.master" AutoEventWireup="true" CodeFile="Committee_Qry_01.aspx.cs" Inherits="Committee_Qry_01" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="QueryConditionContent" Runat="Server">
    <table class="table_gray" cellpadding="0" cellspacing="0" border="1" width="100%">
        <tr>
            ...
            <td class="text_2c">
                <kd:StrTextBox ID="txt_Comm_Name" runat="server" DB_Length="10" title="姓名"></kd:StrTextBox>
            </td>
        ...
        <tr>
            ...
            <td class="text_2c">
                <kd:StrTextBox ID="txt_Comm_ComName" runat="server" DB_Length="50" title="機關名稱"></kd:StrTextBox>
            </td>
            <td class="title_2c">
                專長 :
            </td>
            <td class="text_2c">
                <kd:CoDropDownList ID="ddl_Skill" runat="server" title="專長" isAllowNull="true">
                </kd:CoDropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td class="text_more" colspan="3">
                <asp:CheckBoxList ID="ckl_Comm_CoachWay" runat="server" 
        ...
        <tr>
            ...
            <td class="text_more" colspan="3">
                <asp:CheckBoxList ID="ckl_Comm_CoTerms" runat="server" 
                    RepeatDirection="Horizontal">
                </asp:CheckBoxList>          
            </td>
        </tr>
    ...
    <asp:Panel ID="pnlGridView" runat="server" ScrollBars="Auto" class="search_result">
        <asp:GridView ID="grvQuery" runat="server" AllowPaging="True" PagerSettings-Visible="false"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Comm_Code" HeaderStyle-Font-Bold="false" HeaderText="委員代號">
                ...
                <asp:BoundField DataField="Comm_ComName" HeaderStyle-Font-Bold="false" HeaderText="公司名稱">
                    <HeaderStyle CssClass="table_data_lightblue_head" />
                </asp:BoundField>
