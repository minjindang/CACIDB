<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.master"
    AutoEventWireup="true" CodeFile="Company_Ins_01.aspx.cs" Inherits="Company_Ins_01" %>
                        ...
                        <tr>
                            ...
                            <td class="text_2c">
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        <kd:CoIDNumTextBox ID="txt_Com_Tonum" runat="server" title="單位統編/身分證字號" isAllowNull="false" AutoPostBack="true" OnTextChanged="txt_Com_Tonum_TextChanged"></kd:CoIDNumTextBox>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                        </tr>
