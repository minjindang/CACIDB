    ...
    <table class="table_gray" cellpadding="0" cellspacing="0" border="1" width="100%">
        ...
        <tr>
           <td class="title_2c">
            ...
            <td class="text_2c">
                <kd:StrTextBox ID="txt_PhRec_ComName" runat="server" DB_Length="50" title="單位(公司)名稱"></kd:StrTextBox>
            </td>
           <td class="title_2c">
                統一編號/身分證字號/立案案號 :
            </td>
            <td class="text_2c">
                <kd:StrTextBox ID="txt_PhRec_Tonum" runat="server" DB_Length="50" title="統一編號/身分證字號/立案案號"></kd:StrTextBox>
            </td>
        </tr>
        <tr>
             <td class="title_2c">
            ...
            <td class="text_2c">
                <kd:StrTextBox ID="txt_PhRec_CtName" runat="server" DB_Length="50" title="聯絡人姓名"></kd:StrTextBox>
            </td>
            <td class="title_2c">
                聯絡電話 :
            </td>
            <td class="text_2c">
                <kd:StrTextBox ID="txt_PhRec_CtTel" runat="server" DB_Length="50" title="聯絡電話"></kd:StrTextBox>
            </td>
        </tr>
        <tr>
             <td class="title_2c">
    ...
    <asp:Panel ID="pnlGridView" runat="server" ScrollBars="Auto" class="search_result">
        <asp:GridView ID="grvQuery" runat="server" AllowPaging="True" PagerSettings-Visible="false"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="PhRec_ComName" HeaderStyle-Font-Bold="false" HeaderText="公司名稱">
                     <HeaderStyle CssClass="table_data_lightblue_head_fun_right" />
                </asp:BoundField>
                <asp:BoundField DataField="Com_Tonum" HeaderStyle-Font-Bold="false" HeaderText="統編/身分證字號/立案號">
                     <HeaderStyle CssClass="table_data_lightblue_head_fun_right" />
                </asp:BoundField>
                <asp:BoundField DataField="PhRec_CtName" HeaderStyle-Font-Bold="false" HeaderText="聯絡人姓名">
                     <HeaderStyle CssClass="table_data_lightblue_head_fun_right" />
                </asp:BoundField>
                 <asp:BoundField DataField="CntClass_CodeName" HeaderStyle-Font-Bold="false" HeaderText="提問類別">
                     <HeaderStyle CssClass="table_data_lightblue_head_fun_right" />
                </asp:BoundField>
            </Columns>
