<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterMultiDetailPage.master"
    AutoEventWireup="true" CodeFile="Project_Ins_01.aspx.cs" Inherits="Project_Ins_01" %>
    ...
    <table class="table_gray" cellpadding="0" cellspacing="0" border="1" width="100%">
        <tr>
            ...
            <td class="text_2c">
                ...
                <asp:Label ID="lbl_PjSp_Code" runat="server" Visible="false"></asp:Label>
            </td>
            <td class="title_2c">
                 <font color = "red">*</font>網路申請開放時間:
            </td>
            <td class="text_2c">
                <kd:DateTextBox ID="txt_Pj_BgnDate" runat="server" Width="60" isAllowNull="false"
                    DateType="Taiwan" title="網路申請開放日期(起)"></kd:DateTextBox>
                ...
                ~
                <kd:DateTextBox ID="txt_Pj_EndDate" runat="server" Width="60" isAllowNull="false"
                    DateType="Taiwan" title="網路申請開放日期(迄)"></kd:DateTextBox>
        ...
        <tr>
            <td class="title_2c">
                 <font color = "red">*</font>專案啟動日期:
            </td>
            <td class="text_2c">
                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                    <ContentTemplate>
                        <kd:DateTextBox ID="txt_Pj_StartDate" runat="server" Width="60" DateType="Taiwan"
                            title="專案啟動日期" isAllowNull="false" AutoPostBack="true" OnTextChanged="txt_Pj_StartDate_TextChanged"></kd:DateTextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="lightblue_tb_text_more">
                                                            <kd:StrTextBox ID="txt_Stage_Name" runat="server" title="階段名稱" DB_Length="100" isAllowNull="false"
                                                                ValGroup="grv_PjStage" Width="90%"></kd:StrTextBox>
                                                        </td>
                                                        <td class="lightblue_tb_title_more">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="lightblue_tb_text_more" colspan="3">
                                                            <kd:StrTextBox ID="txt_Stage_Text" runat="server" title="階段內容說明" DB_Length="1000"
                                                                isAllowNull="false" Width="95%" TextMode="MultiLine" Columns="5" ValGroup="grv_PjStage"></kd:StrTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="lightblue_tb_title_more">
                                                        ...
                                                        <td class="lightblue_tb_text_more">
                                                            <kd:CoDropDownList ID="ddl_Stage_MtKind" runat="server" title="會議性質" DataTextField="Mety_Name"
                                                                DataValueField="Mety_Code" isAllowNull="true" ValGroup="grv_PjStage">
                                                            </kd:CoDropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="lightblue_tb_text_more" colspan="3">
                                                            <kd:NumTextBox ID="txt_Stage_RmDays" runat="server" DB_IntLength="2" DB_DecLength="0"
                                                                title="提前提醒天數" Width="30px" ValGroup="grv_PjStage"></kd:NumTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="lightblue_tb_title_more">
                                                        ...
                                                        <td class="lightblue_tb_text_more" colspan="3">
                                                            <kd:StrTextBox ID="txt_Stage_RmText" runat="server" DB_Length="100" title="是否文稿"
                                                                ValGroup="grv_PjStage" Width="90%" TextMode="MultiLine" Columns="3"></kd:StrTextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                            ...
                                                            <asp:Panel ID="pnlGridView2" runat="server" Width="100%">
                                                                <asp:GridView ID="grv_PjStage" runat="server" AutoGenerateColumns="False" Width="100%"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField DataField="Stage_Kind" HeaderStyle-Font-Bold="false" HeaderText="階段名稱代碼"
                                                                            HeaderStyle-VerticalAlign="Bottom">
                                                                            <HeaderStyle CssClass="table_data_lightblue_head" Font-Bold="False" />
                                                                            <ItemStyle CssClass="table_data_white_data" HorizontalAlign="center" />
                                                                        </asp:BoundField>
