<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterDetailPage.master"
    AutoEventWireup="true" CodeFile="Project_Ins_02.aspx.cs" Inherits="Project_Ins_02" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MasterInsertContent" runat="Server">
    <table class="table_gray" cellpadding="0" cellspacing="0" border="1" width="100%">
        ...
        <tr>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <kd:DateTextBox ID="txt_Pj_StartDate" runat="server" Width="60" DateType="Taiwan"
                            AutoPostBack="true" title="專案啟動日期" isAllowNull="false" OnTextChanged="txt_Pj_StartDate_TextChanged"></kd:DateTextBox>
            ...
            <td class="text_2c">
                <kd:CoDropDownList ID="ddl_Pj_Trans" runat="server" title="是否提供轉件">
        ...
        <tr>
            ...
            <td class="text_2c">
                <kd:StrTextBox ID="txt_Pj_Fund" runat="server" DB_Length="50" title="專案經費" isAllowNull="true"></kd:StrTextBox>
        ...
        <tr>
            ...
            <td class="text_more" colspan="3">
                <cc1:Editor ID="Editor1" runat="server" title="外網專案說明"/>
            </td>
        </tr>
        <tr>
            <td class="title_2c">
                    ...
                    <tr>
                        <td>
                            <div 
                                ...
                                style="margin-top: 0px; margin-left: 0px; position: absolute; float: left;
                                background-color: White; padding-left: 2px; top: 1104px; left: 9px; height: 20px;">
                                <div style="float: left;">
                                    <img src="/CACI/image/blueBall.jpg" />
                                </div>
                                <div style="float: left; margin: 0px 3px 0px 3px;">
                            ...
                            <div 
                                ...
                                style="float: right; position: absolute; margin: 0px 10px 0px 680px; background-color: white;
                                padding: 0px 0px 0px 0px; top: 1105px; left: 7px; height: 20px; width: 68px;">
