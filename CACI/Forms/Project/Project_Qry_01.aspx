<%@ Page Title="" Language="C#" MasterPageFile="~/Master/QueryMasterPage.master" AutoEventWireup="true" CodeFile="Project_Qry_01.aspx.cs" Inherits="Project_Qry_01" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="QueryConditionContent" Runat="Server">
    <table class="table_gray" cellpadding="0" cellspacing="0" border="1" width="100%">
        <tr>
            ...
            <td class="text_2c">
                <asp:DropDownList ID="ddl_Pj_Kind" runat="server">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td class="title_2c">網路申請開放日期: </td>
            <td class="text_2c">
                <kd:DateTextBox ID="txt_Pj_BgnDate" runat="server" Width="60" DateType="Taiwan" title="網路申請開放日期(起)" ></kd:DateTextBox>
                <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txt_Pj_BgnDate" Format="yyyy/MM/dd" TodaysDateFormat="yyyy/MM/dd">
                </asp:CalendarExtender>
                ~
                <kd:DateTextBox ID="txt_Pj_FinishDate" runat="server" Width="60" DateType="Taiwan" title="網路申請開放日期(迄)" ></kd:DateTextBox>
                <asp:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txt_Pj_FinishDate" Format="yyyy/MM/dd" TodaysDateFormat="yyyy/MM/dd">
                </asp:CalendarExtender>
            </td>
            <td class="title_2c">專案啟動日期: </td>
            <td class="text_2c">
                <kd:DateTextBox ID="txt_Pj_StartDate" runat="server" Width="60" DateType="Taiwan" title="專案啟動日期(起)" ></kd:DateTextBox>
                ...
                ~
                <kd:DateTextBox ID="txt_Pj_EndDate" runat="server" Width="60" DateType="Taiwan" title="專案啟動日期(迄)" ></kd:DateTextBox>
        ...
        <tr>
            ...
            <td class="text_2c">
                <asp:DropDownList ID="ddl_Pj_User" runat="server">
                </asp:DropDownList>
            </td>
...
<asp:Content ID="Content5" ContentPlaceHolderID="QueryResultContent" Runat="Server">
    <asp:Panel ID="pnlGridView" runat="server" ScrollBars="Auto" class="search_result">
        <asp:GridView ID="grvQuery" runat="server" AllowPaging="True" PagerSettings-Visible="false"
            ...
            DataKeyNames="Pj_Code" AllowSorting="true" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Pj_Kind" HeaderStyle-Font-Bold="false" HeaderText="專案類型" >
                    <HeaderStyle CssClass="table_data_lightblue_head" />
                </asp:BoundField>
                <asp:BoundField DataField="Pj_BgnDate" HeaderStyle-Font-Bold="false" HeaderText="專案網路申請開放時間" >
                    <HeaderStyle CssClass="table_data_lightblue_head" />
                </asp:BoundField>
            </Columns>
