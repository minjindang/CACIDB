<%@ Page Title="" Language="C#" MasterPageFile="~/Master/QueryMasterPage.master"
    AutoEventWireup="true" CodeFile="RPOUT_Qry_02.aspx.cs" Inherits="RPOUT_Qry_02" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="QueryResultContent" runat="Server">
            ...
            <Columns>
                <asp:TemplateField>
                    ...
                    <HeaderTemplate>
                        ...
                        <%--
                        <input type='checkbox' name='cbHead' id='cbHead' onclick='checkAll();'>
                        --%>
                    </HeaderTemplate>
                    <ItemTemplate>
                ...
                <asp:BoundField DataField="ApPj_ApGroup_Name" HeaderStyle-Font-Bold="false" HeaderText="申請組別">
                    <HeaderStyle CssClass="table_data_lightblue_head" />
                    <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
                <asp:BoundField DataField="Comm_Name" HeaderStyle-Font-Bold="false" HeaderText="審查委員">
                    <HeaderStyle CssClass="table_data_lightblue_head" />
                    <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
                <asp:BoundField DataField="ApPj_Msectors_Name" HeaderStyle-Font-Bold="false" HeaderText="產業別">
                    <HeaderStyle CssClass="table_data_lightblue_head" />
                    <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="Times_Bgn_Roc" HeaderStyle-Font-Bold="false" HeaderText="審查日期起">
                    <HeaderStyle CssClass="table_data_lightblue_head" />
                    <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
                <asp:BoundField DataField="Times_End_Roc" HeaderStyle-Font-Bold="false" HeaderText="審查日期迄">
                    <HeaderStyle CssClass="table_data_lightblue_head" />
                    <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
            </Columns>
    ...
    <script type="text/javascript">
        function checkAll() {
            if ($("#cbHead").attr('checked') == true) {
                $('input[id*=cbItem]').attr('checked', true);
            } else {
                $('input[id*=cbItem]').attr('checked', false);
            }
        }
    </script>
    --%>
