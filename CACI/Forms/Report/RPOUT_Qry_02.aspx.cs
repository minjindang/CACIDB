...
public partial class RPOUT_Qry_02 : IQueryUI
{
    /// <summary>
    ...
    protected void PrintToFile(CrystalDecisions.Shared.ExportFormatType Type)
    {
        ...
        RPOUT_02BL _bl = new RPOUT_02BL();
        rpt.Load(Server.MapPath("RPOUT_Prt_02.rpt"));
        DataTO conds = PopulateData();
        rpt.SetDataSource(_bl.getPrintDatas(conds, SelectData));
        rpt.SummaryInfo.ReportTitle = "獎補助專案計畫審查委員彙總表";
