<%@ Page Title="" Language="C#" MasterPageFile="~/Master/QueryMasterPage.master"
    AutoEventWireup="true" CodeFile="RPOUT_Qry_04.aspx.cs" Inherits="RPOUT_Qry_04" %>
            ...
            <ContentTemplate>
                <tr>
                    ...
                    <td class="text_2c" style="width:30%">
                        <kd:StrTextBox ID="txt_Pj_StartDate" runat="server" AutoPostBack="true" DB_Length="3" Width="30px" title="年度" OnTextChanged="txt_Pj_StartDate_TextChanged" isAllowNull="false"/>
                ...
                <tr>
                    ...
                    <td class="text_2c">
                        <kd:DateTextBox runat="server" DateType="Taiwan" ID="txt_Aow_DateS" title="申請日期區間起">
                        </kd:DateTextBox>
                        <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txt_Aow_DateS"
                            Format="yyyy/MM/dd" TodaysDateFormat="yyyy/MM/dd">
                        </asp:CalendarExtender>
                        -
                        <kd:DateTextBox runat="server" DateType="Taiwan" ID="txt_Aow_DateE" title="申請日期區間迄">
                        </kd:DateTextBox>
                        <asp:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txt_Aow_DateE"
                            Format="yyyy/MM/dd" TodaysDateFormat="yyyy/MM/dd">
                        </asp:CalendarExtender>
                    </td>
                    <td class="title_2c">
                        <font color="red">*</font>初審階段名稱 :
                    </td>
                    <td class="text_2c">
                        <kd:CoDropDownList ID="sel_Pj_Stage" runat="server" title="初審階段名稱" DataTextField="Stage_Name" DataValueField="Stage_Index" isAllowNull="false"/>
                    </td>
                </tr>
            </ContentTemplate>
        </asp:UpdatePanel>
    ...
    <asp:Panel ID="pnlGridView" runat="server" ScrollBars="Auto" class="search_result">
        <asp:GridView ID="grvQuery" runat="server" AllowPaging="True" PagerSettings-Visible="false"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="uni_id" HeaderStyle-Font-Bold="false" HeaderText="Aow_Code" Visible="False">
                    <HeaderStyle CssClass="table_data_lightblue_head" />
                    <HeaderStyle Font-Bold="False" />
                </asp:BoundField>                    
                <asp:BoundField DataField="applyCom" HeaderStyle-Font-Bold="false" HeaderText="申請單位/進駐單位">
                    <HeaderStyle CssClass="table_data_lightblue_head" />
                    <HeaderStyle Font-Bold="False" />
                </asp:BoundField>                
                ...
                <asp:BoundField DataField="ApPj_BgnDateToEndDate" HeaderStyle-Font-Bold="false" HeaderText="計畫期程">
                    <HeaderStyle CssClass="table_data_lightblue_head" />
                    <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
                <asp:BoundField DataField="ApPj_TotAmt" HeaderStyle-Font-Bold="false" HeaderText="總經費(千元)">
                    <HeaderStyle CssClass="table_data_lightblue_head" />
                    <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
                <asp:BoundField DataField="ApPj_AowAmt" HeaderStyle-Font-Bold="false" HeaderText="申請補助(千元)">
                    <HeaderStyle CssClass="table_data_lightblue_head" />
                    <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
            </Columns>
