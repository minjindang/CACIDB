...
public partial class RPOUT_Qry_09 : IQueryUI
{
    /// <summary>
    ...
    public override void SetProp()
    {
        ...
        ProgNm = "「文建會補助直轄市及縣(市)政府推動文化創意產業發展」推薦統計表";//程式名稱
    ...
    public override void SetDefault()
    {
        ...
        string year = Convert.ToString(sysDate.Year-1911);
        sel_Pj_Name.DataSource = new RPOUT_CommonBL().getProjectName(year);
    ...
    protected void PrintToFile(CrystalDecisions.Shared.ExportFormatType Type)
    {
        ...
        RPOUT_09BL _bl = new RPOUT_09BL();
        rpt.Load(Server.MapPath("RPOUT_Prt_09.rpt"));
        ...
        rpt.SummaryInfo.ReportTitle = "「文建會補助直轄市及縣(市)政府推動文化創意產業發展」推薦統計表";
