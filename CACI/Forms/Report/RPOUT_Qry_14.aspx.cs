...
public partial class RPOUT_Qry_14 : IQueryUI
{
    ///// <summary>
    ...
    public void PrintToFile(CrystalDecisions.Shared.ExportFormatType Type)
    {
        ...
        RPOUT_14BL BL_14 = new RPOUT_14BL();
        rpt.Load(Server.MapPath("RPOUT_Prt_14.rpt"));
        DataTO conds = PopulateData();
        rpt.SetDataSource(BL_14.getPrintInfo(conds, SelectData));
