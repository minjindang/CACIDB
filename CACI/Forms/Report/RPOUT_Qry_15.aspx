<%@ Page Title="" Language="C#" MasterPageFile="~/Master/QueryMasterPage.master"
    AutoEventWireup="true" CodeFile="RPOUT_Qry_15.aspx.cs" Inherits="RPOUT_Qry_15"  %>
        ...
        <tr>
         ...
         <tr>
            ...
            <td class="text_2c">
                ...
                <kd:DateTextBox ID="Times_BgnS" runat="server" title="詢問日期區間" DateType="Taiwan" ></kd:DateTextBox>~
                <asp:CalendarExtender TargetControlID="Times_BgnS" ID="CalendarExtender3" TodaysDateFormat="yyyy/MM/dd" runat="server">
                </asp:CalendarExtender>
                <kd:DateTextBox ID="Times_BgnE" runat="server" title="詢問日期區間" DateType="Taiwan" ></kd:DateTextBox>

                <asp:CalendarExtender TargetControlID="Times_BgnE" ID="CalendarExtender4" TodaysDateFormat="yyyy/MM/dd" runat="server">
                </asp:CalendarExtender>
    ...
    <asp:Panel ID="pnlGridView" runat="server" ScrollBars="None" CssClass="search_result">
        <asp:GridView ID="grvQuery" runat="server" AllowPaging="True" PagerSettings-Visible="false"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="ChKd_Name" HeaderStyle-Font-Bold="false" HeaderText="輔導面向">
                <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
                 <asp:BoundField DataField="Coach_Date" HeaderStyle-Font-Bold="false" HeaderText="申請日期">
                <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
                <asp:BoundField DataField="Times_Bgn" HeaderStyle-Font-Bold="false" HeaderText="輔導時間">
                <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
