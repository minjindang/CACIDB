...
public partial class RPOUT_Statics_Qry_02 : IQueryUI
{
    ...
    public override void SetProp()
    {
        ...
        #region 導向頁面資訊
        //InsertPage = "RPOUT_Statics_Qry_02.aspx";//新增頁
        //ModifyPage = "RPOUT_Statics_Qry_02.aspx";//修改頁
        //ListPage = "RPOUT_Statics_Qry_02.aspx"; //顯示頁
        #endregion 導向頁面資訊
    ...
    public override void SetDefault()
    {
        ...
        ddl_Cnst_CntDate.DataSource = ((RPOUT_Statics_02BL)BL).getYear();
    ...
    protected void PrintToFile(CrystalDecisions.Shared.ExportFormatType Type)
    {
        ...
        RPOUT_Statics_02BL Statics_02BL = new RPOUT_Statics_02BL();
        rpt.Load(Server.MapPath("RPOUT_Statics_Prt_02.rpt"));
        DataTO conds = PopulateData();
        rpt.SetDataSource(Statics_02BL.getPrintInfo(conds, ""));
