<%@ Page Title="" Language="C#" MasterPageFile="~/Master/QueryMasterPage.master"
    AutoEventWireup="true" CodeFile="RPOUT_Statics_Qry_03.aspx.cs" Inherits="RPOUT_Statics_Qry_03"  %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="QueryConditionContent" runat="Server">
    <table class="table_gray" cellpadding="0" cellspacing="0" border="1" width="100%">
        <tr>
            ...
            <td class="text_2c">
                <kd:CoDropDownList ID="ddl_Pj_Name" runat="server" title="Pj_Name" 
                    ...
                    onselectedindexchanged="ddl_Pj_Name_SelectedIndexChanged">                  
        ...
        <tr>
            ...
            <td class="text_2c">
            <kd:StrTextBox ID="Year"  runat="server" DB_Length="10" title="年度" MaxLength="4" Size="3" AutoPostBack="true" isAllowNull="false"/>
...
<asp:Content ID="Content5" ContentPlaceHolderID="QueryControlContent" runat="Server">
    <table cellpadding="0" cellspacing="0" align="left" 
        style="background-color: transparent" frame="above">
        <tr>
            <td>
...
<asp:Content ID="Content6" ContentPlaceHolderID="QueryResultContent" runat="Server">
    <asp:Panel ID="pnlGridView" runat="server" ScrollBars="None" CssClass="search_result">
        <asp:GridView ID="grvQuery" runat="server" AllowPaging="True" PagerSettings-Visible="false"
            ...
            <Columns>
                <asp:BoundField DataField="Sys_CdText" HeaderStyle-Font-Bold="false" HeaderText="產業別/年度">
                <HeaderStyle Font-Bold="False" />

                </asp:BoundField>
                  <asp:BoundField DataField="yearCount" HeaderStyle-Font-Bold="false" HeaderText="當年度個數">
                <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
                <asp:BoundField DataField="yearCountPer" HeaderStyle-Font-Bold="false" HeaderText="當年度百分比">
                <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
                <asp:BoundField DataField="accuCount" HeaderStyle-Font-Bold="false" HeaderText="累計年度個數">
                <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
                <asp:BoundField DataField="accuCountPer" HeaderStyle-Font-Bold="false" HeaderText="累計百分比">
                <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
            </Columns>
