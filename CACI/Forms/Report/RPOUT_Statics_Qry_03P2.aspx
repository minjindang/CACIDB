<%@ Page Title="" Language="C#" MasterPageFile="~/Master/QueryMasterPage.master"
    AutoEventWireup="true" CodeFile="RPOUT_Statics_Qry_03P2.aspx.cs" Inherits="RPOUT_Statics_Qry_03"  %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="QueryResultContent" runat="Server">
    <asp:Panel ID="pnlGridView" runat="server" ScrollBars="None" CssClass="search_result">
        <asp:GridView ID="grvQuery" runat="server" AllowPaging="True" PagerSettings-Visible="false"
            ...
            BorderColor="#3C6ED4" DataKeyNames="name" AllowSorting="True" 
            ...
            <Columns>
                <asp:BoundField DataField="name" HeaderStyle-Font-Bold="false" HeaderText="登記類型/年度">
                <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
                  <asp:BoundField DataField="yearCount" HeaderStyle-Font-Bold="false" HeaderText="當年度個數">
                <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
                <asp:BoundField DataField="yearCount" HeaderStyle-Font-Bold="false" HeaderText="當年度百分比">
                <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
                <asp:BoundField DataField="accuCount" HeaderStyle-Font-Bold="false" HeaderText="累計年度個數">
                <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
                <asp:BoundField DataField="accuCount" HeaderStyle-Font-Bold="false" HeaderText="累計百分比">
                <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
            </Columns>
