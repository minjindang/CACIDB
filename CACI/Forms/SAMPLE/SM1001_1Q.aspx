<%@ Page Title="" Language="C#" MasterPageFile="~/Master/QueryMasterPage.master"
    AutoEventWireup="true" CodeFile="SM1001_1Q.aspx.cs" Inherits="SM1001_1Q"  %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="QueryConditionContent" runat="Server">
    <table class="table_green" cellpadding="0" cellspacing="1" border="0" width="858px">
        <tr>
...
<asp:Content ID="Content6" ContentPlaceHolderID="QueryResultContent" runat="Server">
    <asp:Panel ID="pnlGridView" runat="server" Width="858px" ScrollBars="None" CssClass="inScroll">
        <kd:MDGridView ID="grvQuery" runat="server" AllowPaging="True" PagerSettings-Visible="false"
            AutoGenerateColumns="False" Width="858px" BorderWidth="1px" CellPadding="0" CloseIconPath="~/image/open.png" OpenIconPath="~/image/close.png"
            BorderColor="#3C6ED4" DataKeyNames="Mcol_1" AllowSorting="True" LoadControlMode="UserControl" TemplateCachingBase="Tablename" TemplateDataMode="RunTime">
