...
public partial class SM1003Q : IQueryUI
{
    /// <summary>
    ...
    public override void SetProp()
    {
        ...
        ProgNm = "Master-Detail-Detail 查詢作業範本";//程式名稱
        ...
        #region 導向頁面資訊
        InsertPage = "SM1003I.aspx";//新增頁
        ModifyPage = "SM1003M.aspx";//修改頁
        ListPage = "SM1003L.aspx"; // 顯示頁
        #endregion 導向頁面資訊
