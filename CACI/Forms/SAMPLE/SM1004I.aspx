<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterDetailPage.master"
    AutoEventWireup="true" CodeFile="SM1004I.aspx.cs" Inherits="SM1004I" %>
        ...
        <table class="table_lightblue" cellpadding="0" cellspacing="0" border="1" width="100%">
            <tr>
                ...
                <td class="lightblue_tb_text_more">
                    <kd:StrTextBox ID="txt_DDcol_2" runat="server" title="Dcol_2" DB_Length="10" ValGroup="grvQuery"></kd:StrTextBox>
                </td>
                <td class="lightblue_tb_title_more" >Dcol_3</td>
                <td class="lightblue_tb_text_more">
                    <kd:StrTextBox ID="txt_DDcol_3" runat="server" title="Dcol_3" DB_Length="10" ValGroup="grvQuery"></kd:StrTextBox>
                </td>
            </tr>
        </table>
    </div>
