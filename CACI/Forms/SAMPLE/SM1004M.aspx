<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterDetailPage.master"
    AutoEventWireup="true" CodeFile="SM1004M.aspx.cs" Inherits="SM1004M" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="DetailInsertContent" runat="Server">
    ...
    <div class="table_detail_info" >
        <table class="table_lightblue" cellpadding="0" cellspacing="0" border="1" width="100%">
            <tr>
                <td class="lightblue_tb_title_more" >Dcol_2&nbsp;</td>
                <td class="lightblue_tb_text_more">
                    <kd:StrTextBox ID="txt_DDcol_2" runat="server" title="DDcol_2" DB_Length="10" ValGroup="grvQuery"></kd:StrTextBox>
                </td>
                <td class="lightblue_tb_title_more" >Dcol_3</td>
                <td class="lightblue_tb_text_more">
                    <kd:StrTextBox ID="txt_DDcol_3" runat="server" title="DDcol_3" DB_Length="10" ValGroup="grvQuery"></kd:StrTextBox>
                </td>
            </tr>
        </table>
    </div>
        ...
        <tr>
            <td>
                ...
                <table cellpadding="0px" cellspacing="1px" width="100%">
                    <tr>
                        <td>
                            <asp:Panel ID="pnlQueryGridView" runat="server" Width="100%" class="detail_result">
                                <asp:GridView ID="grvQueryData" runat="server" AutoGenerateColumns="False" Width="100%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="DDcol_2" HeaderStyle-Font-Bold="false" HeaderText="Dcol_2"
                                        ...
                                        <asp:BoundField DataField="DDcol_3" HeaderStyle-Font-Bold="false" HeaderText="Dcol_3"
                    ...
                    <tr>
                        <td>
                            <table cellpadding="0" width="100%" cellspacing="0">
                                <tr>
                                    <td>
                                        <div style=" margin-top: 25px; margin-left:16px; position: absolute; float:left; background-color:White; padding-left:2px; ">
                                            <div style=" float:left; ">
                                                <img src="/CACI/image/blueBall.jpg" />
                                            </div>
                                            <div style=" float:left; margin:0px 3px 0px 3px; ">
                                        ...
                                        <div  style=" float:left; position: absolute; margin: 15px 10px 0px 680px; background-color:white; padding:10px 0px 0px 6px;" >
