<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.master"
    AutoEventWireup="true" CodeFile="Announcement_Ins_01.aspx.cs" Inherits="Announcement_Ins_01" %>
    ...
    <table class="table_gray" cellpadding="0" cellspacing="0" border="1" width="100%">
        <tr>
            ...
            <td class="text_2c">
                ...
                <asp:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="txt_Ann_BgnTime" Format="yyy/MM/dd" TodaysDateFormat="yyyy/MM/dd" >
                </asp:CalendarExtender>
                <asp:CalendarExtender ID="CalendarExtender4" runat="server" TargetControlID="txt_Ann_EndTime" Format="yyy/MM/dd" TodaysDateFormat="yyyy/MM/dd" >
                </asp:CalendarExtender>
            </td>
        </tr>
        <tr>
