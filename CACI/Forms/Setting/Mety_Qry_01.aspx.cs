...
public partial class Mety_Qry_01 : IQueryUI
{
    /// <summary>
    ...
    {
        if (to.getValue("Pj_Kind").ToString() != "")
    ...
    public override void SetProp()
    {
        ...
        #region 導向頁面資訊
        InsertPage = "Mety_Ins_01.aspx";//新增頁
        ModifyPage = "Mety_Upd_01.aspx";//修改頁
        #endregion 導向頁面資訊
