<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.master"
    AutoEventWireup="true" CodeFile="Program_Ins_01.aspx.cs" Inherits="Program_Ins_01" %>
    ...
    <table class="table_gray" cellpadding="0" cellspacing="0" border="1" width="100%">
        <tr>
            ...
            <td class="text_2c" style="color:Red">
                <kd:StrTextBox ID="txt_Prog_Num" runat="server" DB_Length="10" title="程式代號" isAllowNull="false"></kd:StrTextBox>
            </td>
