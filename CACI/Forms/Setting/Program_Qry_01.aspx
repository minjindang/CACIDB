<%@ Page Title="" Language="C#" MasterPageFile="~/Master/QueryMasterPage.master"
    AutoEventWireup="true" CodeFile="Program_Qry_01.aspx.cs" Inherits="Program_Qry_01"  %>
        ...
        <tr>
            ...
            <td class="text_2c">
                <kd:CoDropDownList ID="ddl_Prog_Class" runat="server" DataTextField="Sys_CdText" 
                    DataValueField="Sys_CdCode" title="作業類別" isAllowNull="true" ></kd:CoDropDownList>
            </td>
...
<asp:Content ID="Content6" ContentPlaceHolderID="QueryResultContent" runat="Server">
    <asp:Panel ID="pnlGridView" runat="server" ScrollBars="Auto" CssClass="search_result">
        <asp:GridView ID="grvQuery" runat="server" AllowPaging="True" PagerSettings-Visible="false"
            ...
            BorderColor="#3C6ED4" DataKeyNames="Prog_Num" AllowSorting="True" EnableViewState="true" >
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Prog_Num" HeaderStyle-Font-Bold="false" HeaderText="作業代號">
                <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
                <asp:BoundField DataField="Prog_Type" HeaderStyle-Font-Bold="false" HeaderText="程式類型">
                <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
                <asp:BoundField DataField="Prog_Name" HeaderStyle-Font-Bold="false" HeaderText="程式名稱">
                <HeaderStyle Font-Bold="False" />
                </asp:BoundField>
            </Columns>
