...
public partial class Program_Qry_01 : IQueryUI
{
    /// <summary>
    ...
    public override DataTO PopulateData()
    {
        ...
        if (ddl_Prog_Class.SelectedValue != "")
    ...
    {
        if (to.getValue("Prog_Class").ToString() != "")
            ddl_Prog_Class.SelectedValue = to.getValue("ddl_Prog_Class").ToString();
    }
    ...
    public override void SetProp()
    {
        ...
        #region 導向頁面資訊
        InsertPage = "Program_Ins_01.aspx";//新增頁
        ModifyPage = "Program_Upd_01.aspx";//修改頁
        #endregion 導向頁面資訊
