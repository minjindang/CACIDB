...
public partial class SYSAP_Qry_01 : IQueryUI
{
    /// <summary>
    ...
    public override DataTO PopulateData()
    {
        ...
        if (txt_Sys_CdNote.Text != "")
            to.setValue("Sys_CdNote", txt_Sys_CdNote.Text);
    ...
    {
        txt_Sys_CdNote.Text = to.getValue("Sys_CdNote").ToString();
    }
    ...
    public override void SetProp()
    {
        ...
        ModifyPage = "SYSAP_Upd_01.aspx";//修改頁
        #endregion 導向頁面資訊
    ...
    {
        grvQuery.DataSource = new BaseFun().getDistinctSysCodeKind();
        grvQuery.DataBind();
    }
}