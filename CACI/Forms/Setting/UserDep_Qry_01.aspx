<%@ Page Title="" Language="C#" MasterPageFile="~/Master/QueryMasterPage.master"
    AutoEventWireup="true" CodeFile="UserDep_Qry_01.aspx.cs" Inherits="UserDep_Qry_01"  %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="QueryConditionContent" runat="Server">
    <table class="table_gray" cellpadding="0" cellspacing="0" border="1" width="100%">
        <tr>
            ...
            <td class="text_2c">
                <kd:StrTextBox ID="txt_UsDp_Code" runat="server" DB_Length="10" title="單位代碼" Width="90%"></kd:StrTextBox>
            </td>
             <td class="title_2c">單位名稱: </td>
            <td class="text_2c">
                <kd:StrTextBox ID="txt_UsDp_Name" runat="server" DB_Length="10" title="單位名稱" Width="90%"></kd:StrTextBox>
            </td>
...
<asp:Content ID="Content6" ContentPlaceHolderID="QueryResultContent" runat="Server">
    <asp:Panel ID="pnlGridView" runat="server" ScrollBars="Auto" CssClass="search_result">
        <asp:GridView ID="grvQuery" runat="server" AllowPaging="True" PagerSettings-Visible="false"
            ...
            BorderColor="#3C6ED4" DataKeyNames="UsDp_Code" AllowSorting="True" EnableViewState="true" >
            <PagerSettings Visible="False" />
            <Columns>
                <asp:ButtonField ButtonType="Image" CommandName="mod" ImageUrl="~/image/btn_Update.jpg">
                ...
                <asp:BoundField DataField="UsDp_IsUsd" HeaderStyle-Font-Bold="false" HeaderText="是否有效">
                </asp:BoundField>
            </Columns>
