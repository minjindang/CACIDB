...
public partial class AowStage_Upd_02 : System.Web.UI.UserControl
{
    ...
    {
        this.DataBinding += new EventHandler(AowStage_Upd_02_DataBinding);
    }

    void AowStage_Upd_02_DataBinding(object sender, EventArgs e)
    {
        ...
        to.setValue("Aow_Code", key[0].ToString());
