<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CoachStage_Upd_01.ascx.cs"
    Inherits="CoachStage_Upd_01" %>
...
<table class="table_lightYellow" style="margin-top: 10px;" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td class="lightyellow_tb_title_more" colspan="4">
            ...
            <asp:HiddenField ID="hf_Coach_Code" runat="server" />
    ...
    <tr>
        ...
        <td class="lightyellow_tb_text_more" colspan="3">
            <asp:Label ID="lbl_CoachStage_Date" runat="server" Text=""></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="lightyellow_tb_title_more">
    ...
    <tr>
        ...
        <td class="lightyellow_tb_text_more">
            <kd:DateTextBox ID="txt_ChSg_Date" runat="server" Width="60" DateType="Taiwan" title="執行日期"></kd:DateTextBox>
            <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txt_ChSg_Date"
        ...
        <td class="lightyellow_tb_text_more">
            <asp:DropDownList ID="ddl_ChSg_Verify" runat="server">
            </asp:DropDownList>
        </td>
    </tr>
    <tr>
        <td class="lightyellow_tb_text_more" colspan="3">
            <kd:StrTextBox ID="txt_ChSg_Text" runat="server" DB_Length="500" title="審核結果" Width="95%"
