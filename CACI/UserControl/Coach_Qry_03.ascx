<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Coach_Qry_03.ascx.cs"
    Inherits="Coach_Qry_03" %>
...
<table class="table_lightYellow" style="margin-top: 10px;" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td class="lightyellow_tb_text_more" >
            <asp:GridView ID="grv_Coach" runat="server" AutoGenerateColumns="False" Width="100%"
                BorderWidth="1px" DataKeyNames="Com_Code,Coach_Code"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Times_Bgn" HeaderStyle-Font-Bold="false" HeaderText="會議時間"
                        ItemStyle-Wrap="true" HeaderStyle-VerticalAlign="Bottom">
                        <HeaderStyle CssClass="table_data_lightblue_head" Font-Bold="False" />
                        <ItemStyle CssClass="table_data_white_data" HorizontalAlign="center" />
                    </asp:BoundField>
        ...
        <td class="lightyellow_tb_text_more" >
            <asp:GridView ID="grv_Phone" runat="server" AutoGenerateColumns="False" Width="100%"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="PRcRp_Date" HeaderStyle-Font-Bold="false" HeaderText="記錄時間"
                        ItemStyle-Wrap="true" HeaderStyle-VerticalAlign="Bottom">
                        <HeaderStyle CssClass="table_data_lightblue_head" Font-Bold="False" />
                        <ItemStyle CssClass="table_data_white_data" HorizontalAlign="center" />
                    </asp:BoundField>
