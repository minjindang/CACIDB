<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PjStage_Lis_03.ascx.cs"
    Inherits="PjStage_Lis_03" %>
    ...
    <tr>
        <td>
            <table class="table_lightblue" style="margin-top: 10px;" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td class="lightblue_tb_title_more">執行日期
                                                </td>
                    <td class="lightblue_tb_text_more" colspan="3">
                        <asp:Label ID="lbl_Stage_Date" runat="server" ></asp:Label>
                    </td>
                </tr>
                <tr>
