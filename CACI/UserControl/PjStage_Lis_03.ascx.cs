...
public partial class PjStage_Lis_03 : System.Web.UI.UserControl
{
    ...
    void PjStage_Lis_01_DataBinding(object sender, EventArgs e)
    {
        ...
        //if(!string.IsNullOrEmpty(lbl_Stage_Date.Text))
        //    lbl_Stage_Date.Text = Project_01BL.chgEnDateToChnDate(pjStageTo.getValue("Stage_Date").ToString().Split(' ')[0]);
